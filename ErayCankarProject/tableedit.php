...
.edit_tr:hover
{
background:url(edit.png) right no-repeat #fcfab3;
cursor:pointer;
}
.edit_tr
{
...
.head
{
background: none repeat scroll 0 0 #f5f27f;
color:#00000;
...
<h1 style="color:#197070">Inventory Management And Track Application</h1>
<ol id="toc">
...
?></h2><br /><br />
<input name="" type="button" value="Print Table" onClick="window.print()" style="cursor:pointer;" />
</div>
...
<form action="updateproduct.php" method="post">
	...
	<br />
	Number of Item:<input name="itemnumber" type="text" /><br />
